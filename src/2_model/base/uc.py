...
class UnitCommitment:
    ...
    def define_sets(self, m):
        ...
        m.T = RangeSet(1, 48, ordered=True)
    ...
    def fix_interval_overlap(m, year, week, day, overlap, output_dir):
        ...
        for t in range(1, overlap + 1):
            ...
            for g in m.G_THERM:
                ...
                m.v[g, t].fix(previous_solution[(year, week, day)]['v'][(g, interval_map[t])])
                m.w[g, t].fix(previous_solution[(year, week, day)]['w'][(g, interval_map[t])])
