...
class MPCController:
    ...
    def define_sets(self, m, eligible_generators, n_intervals, n_scenarios):
        """Define model sets"""

        # Generators eligible to receive subsidy
        m.G = Set(initialize=eligible_generators)
    ...
    def define_expressions(m):
        ...
        def generator_scenario_revenue_rule(_m, g, c, s):
            ...
            return (m.EMISSIONS_RATE[g] - m.baseline[c]) * m.ENERGY_FORECAST[g, c, s] * m.PERMIT_PRICE
    ...
    def construct_model(self, eligible_generators, n_intervals, n_scenarios):
        """Construct MPC model"""
        ...
        # Define sets
        m = self.define_sets(m, eligible_generators, n_intervals, n_scenarios)
    ...
    def run_baseline_updater(self, m, year, week, baseline_start, revenue_start, revenue_target, revenue_floor,
        ...
        parameters = {'year': year, 'week': week,
                      ...
                      'permit_price': m.PERMIT_PRICE.value}
